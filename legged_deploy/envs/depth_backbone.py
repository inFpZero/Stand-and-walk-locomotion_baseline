...
class RecurrentDepthBackbone(nn.Module):
    ...
    # def __init__(self) -> None:
        ...
        # if self.env_cfg == None:
        #     self.combination_mlp = nn.Sequential(
        #                             nn.Linear(32 + 53, 128),
        #                             activation,
        #                             nn.Linear(128, 32)
        #                         )
        # elif self.env_cfg.env.only_proprio:
        self.combination_mlp = nn.Sequential(
                                    nn.Linear(38, 128),
                                    activation,
                                    nn.Linear(128, 128)
        ...
        self.rnn = nn.GRU(input_size=128, hidden_size=512, batch_first=True)
        
        self.hidden_states = None

    def forward(self, proprioception,depth_image=None):
        # if self.env_cfg.env.only_proprio:
        depth_latent = self.combination_mlp(proprioception)
        # else:
